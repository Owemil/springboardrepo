...
class Company {
   ...
   * name:full or partial case insensitive,
  ...
  static async get(handle) {
    ...
    //shortened company to c for ease of typing
    const c = companyRes.rows[0];
    const jobs = companyRes.rows.map(j => ({ id: j.id, title: j.title, salary: j.salary, equity: j.equity }))
