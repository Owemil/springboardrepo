...
describe("GET /companies", function () {
  ...
  test("works: all filters", async function () {
    ...
    expect(resp.body).toEqual({ companies: [{ description: "Desc2", handle: "c2", logoUrl: "http://c2.img", name: "C2", numEmployees: 2 }, { description: "Desc3", handle: "c3", logoUrl: "http://c3.img", name: "C3", numEmployees: 3 }] })
  })
  ...
  test("fails schema:inapropriate filter w/proper filters ", async function () {
    try {
      const resp = await request(app)
        .get("/companies")
        .query(
  ...
  test("fails schema:min/max values are str ", async function () {
    try {
      const resp = await request(app)
        .get("/companies")
        .query(
